...
class FuncNode : public SyntaxNode {
    ...
    public:
        ...
        virtual bool equals( const string& funcName, vector<DataTypeNode*>& paramsType ) = 0;
...
class GlobalFuncNode : public FuncNode {
    ...
    public:
        GlobalFuncNode( const string& name = "", 
                        DataTypeNode* retType = NULL, 
        ...
        virtual vector<VarNode>& getParamList() {
            return m_paramList;
        }
...
class ClassFuncNode : public FuncNode {
   ...
   public:
       ...
       virtual DataTypeNode* getRetType() { 
           return m_func->getRetType();
       }

       virtual void setBody( SyntaxNode* body ) { 
           m_func->setBody(body); 
       }
       virtual SyntaxNode* getBody() { 
           return m_func->getBody(); 
       }
       ...
       virtual vector<VarNode>& getParamList() {
           return m_func->getParamList();
       }

       virtual void addParam( const VarNode& param ) {
           m_func->addParam( param );
       }

       virtual bool hasReturn() {
           return m_func->hasReturn();
       }

       virtual void setReturn( bool hasRet ) { 
           m_func->setReturn( hasRet );
       }

       virtual bool equals( const FuncNode& funcNode );

       virtual bool equals( const string& funcName, vector<DataTypeNode*>& paramsType ){
...
class CallNode : public ExpNode{
    ...
    public:
        ...
        void getParamsType( vector<DataTypeNode*>& paramsType ); //paramsType is output
